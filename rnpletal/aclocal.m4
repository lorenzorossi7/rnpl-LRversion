...
dnl                    AC_MSG_CHECKING(for CCF77LIBS setting)
                       ...
                       *)
                          ...
                          echo "+++ Assuming that setting of CPPFLAGS, CXXFLAGS and CCF77LIBS from version 14 will still work"
                          CPPFLAGS="$CPPFLAGS -wd177,266 -DINTEL_8_OR_LATER -DLINUX -DPORT_GROUP -DWant_c_files"
                          CXXFLAGS="$CXXFLAGS -DINTEL_8_OR_LATER -DLINUX -DPORT_GROUP -DWant_c_files"
                          if test "X$CCF77LIBS" = "X"; then
                             CCF77LIBS="-lsvml -lifcore -lm"
...
dnl----------------------------------------------------------------------
                    if test "X$CCF77LIBS" = "X"; then 
                        if $F77 --version | grep g77 > /dev/null; then
                           CCF77LIBS='-lg2c -lm';
                        else
...
AC_DEFUN(CPPFLAGS_GFORTRAN,[
   if gfortran --version | grep ' 4.1' > /dev/null; then
      CPPFLAGS="$CPPFLAGS -DGFORTRAN41";
   elif gfortran --version | grep ' 4.2' > /dev/null; then
      CPPFLAGS="$CPPFLAGS -DGFORTRAN42";
   elif gfortran --version | grep ' 4.3' > /dev/null; then
      CPPFLAGS="$CPPFLAGS -DGFORTRAN43_OR_LATER";
   elif gfortran --version | grep ' 4.4' > /dev/null; then
      CPPFLAGS="$CPPFLAGS -DGFORTRAN43_OR_LATER";
   elif gfortran --version | grep ' 4.5' > /dev/null; then
      CPPFLAGS="$CPPFLAGS -DGFORTRAN43_OR_LATER";
   elif gfortran --version | grep ' 4.6' > /dev/null; then
      CPPFLAGS="$CPPFLAGS -DGFORTRAN43_OR_LATER";
   elif gfortran --version | grep ' 4.7' > /dev/null; then
      CPPFLAGS="$CPPFLAGS -DGFORTRAN43_OR_LATER";
   elif gfortran --version | grep ' 4.8' > /dev/null; then
      CPPFLAGS="$CPPFLAGS -DGFORTRAN43_OR_LATER";
   elif gfortran --version | grep ' 4.9' > /dev/null; then
      CPPFLAGS="$CPPFLAGS -DGFORTRAN43_OR_LATER";
   else
