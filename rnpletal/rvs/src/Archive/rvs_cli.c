...
int vsxyn(char *name, DVEC x, DVEC y, int n)
{
   STD_DECL
...
int vsxynt(char *name, double time, DVEC x, DVEC y, int n)
{
   STD_DECL 
...
int vsxytagnt(char *name, double time, DVEC x, DVEC y, IVEC tag, int n)
{
   STD_DECL 
...
int vssxynt(char *name, float time, SVEC x, SVEC y, int n)
{
   STD_DECL 
...
int vsxn(char *name, DVEC x, int n)
{
   STD_DECL
...
int vsxnt(char *name, double time, DVEC x, int n)
{
   STD_DECL
...
int vsmxynt(char *name, IVEC start, DVEC time, int nvec, DVEC x, DVEC y)
{
   STD_DECL
...
int vsgnxyni(char *name,int index) 
{
   STD_DECL
...
int vsnsct(char *name,double sc,double time)
{
   STD_DECL
...
int vsgxyni(char *name, int index, DVEC x, DVEC y, Pint pn, Pdouble ptime)
{
   int               ltrace = OFF; 
...
int vsgxynall(char *name,DVEC x,DVEC y,IVEC N,DVEC Time) {
   int                    ltrace = OFF;
...
int vsgetparametern(char *name,int which_parameter)
{
   STD_DECL
