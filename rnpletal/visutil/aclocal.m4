...
dnl immediately.
dnl
dnl Last modified: Wed Jun 11 14:22:59 PDT 2014
dnl
dnl ======================================================================
dnl ****************************************************************
dnl *** IMPORTANT!!   BE SURE TO 'make' AFTER CHANGING THIS FILE ***
dnl ****************************************************************
dnl 
dnl  
dnl NOTES:
...
dnl
dnl (7) February 17 2004
dnl
dnl     New versions of Intel Compilers 8.0 change
dnl
dnl     a) Name of Fortran compiler 'ifort'
dnl     b) Libraries needed to link C/Fortran
dnl
dnl (8) July 28, 2004
dnl
dnl     Shouldn't use CPP symbol __ since OSF/1 CC seems to define it by 
dnl     default. Suggest -D__L  (L for local).
dnl
dnl (9) December 25, 2004
dnl
dnl     Add CFLAGS_NOOPT since previous kludge fails on SGI (need -64)
dnl
dnl (10) July 4, 2006
dnl
dnl     Going way out on the limb and making the use of 'ccmt-cnvt' (C 
dnl     executable, currently part of the $HOMEMWC/scripts "distro",
dnl     and 'ccmt-cnvt-all-h' a shell-script front-end to the afore-
dnl     mentioned executable.  
dnl
dnl     MANY THINGS ARE THUS LIKELY TO "BREAK" (i.e. "Matt, this configured
dnl     and compiled the other day") DUE TO THE LACK OF 'ccmt-cnvt-all-h'
dnl     etc., but OF COURSE, NO ONE BUT MWC WILL EVER READ THIS AT A 
dnl     PROPITIOUS JUNCTURE!!
dnl 
dnl     Caveat Emptor
dnl
dnl (11) November 15, 2007
dnl
dnl     Adding support for Intel compilers version 10
dnl
dnl (12) December 15, 2008
dnl
dnl     Adding support for Intel compilers version 11
dnl
dnl (13) October 20, 2009
dnl
dnl     Added CPPFLAGS_GFORTRAN since external names of intrinsic
dnl     depend on version of gfortran being used under linux
dnl     (don't know about Darwin yet)
dnl
dnl     -DGFORTRAN -> -DGFORTRAN42
dnl                   -DGFORTRAN43
dnl                   -DGFORTRAN44
dnl
dnl (12) April 5, 2011
dnl
dnl     Adding support for Intel compilers version 12
dnl
dnl (13) January 12, 2012
dnl
dnl     Adding support for gfortran versions 4.5 and 4.6
dnl
dnl (14) February 15, 2012
dnl
dnl     Deleting checks for libjvs.a, libsv.a from BBH_MWC_F77_SETUP
dnl
dnl (15) March 21, 2012
dnl
dnl     Adding support for Intel 64-bit compilers
dnl  
dnl (16) December 7, 2012
dnl
dnl     Adding support for Intel compilers version 13 
dnl
dnl (17) September 12, 2014 (some items undoubtedly missing!)
dnl
dnl      Changed DGFORTRAN43, ... -> DGFORTRAN43_OR_LATER
dnl 
dnl     -O2 default for gfortran compilation under Darwin
dnl ======================================================================
...
dnl   Ensure 'prefix' is sanely set
      ...
      RPCGEN_CPPFLAGS=""
      AC_MSG_CHECKING(for Unix/Compiler flavour)
...
dnl ----------------------------------------------------------------------
                 ...
                 CFLAGS_NOOPT="$CFLAGS_NOOPT -woff 1174,1178,1552"
...
dnl ----------------------------------------------------------------------
                 ...
                 X32)
                     ...
                     CFLAGS_NOOPT="$CFLAGS_NOOPT -DSGI -32";
                 ...
                 Xn32|XN32)
                     ...
                     CFLAGS_NOOPT="$CFLAGS_NOOPT -DSGI -n32"
                 ...
                 *)
                     ...
                     CFLAGS_NOOPT="$CFLAGS_NOOPT -DSGI -64";
                 ...
                 *)
                     ...
                     CFLAGS_NOOPT="$CFLAGS_NOOPT -WK,-listoption=O -pfa -mp";
...
dnl              Allow user to override the setting of the cc transform
dnl              script
                 if test "X$CC_TRANSFORM" = "X"; then
                    CC_TRANSFORM="cat"
                 fi
...
dnl                                       F77_TRANSFORM="touch";
                 CFLAGS="$CFLAGS -DSGI"
                 CFLAGS_NOOPT="$CFLAGS_NOOPT -DSGI"
                 CPPFLAGS="$CPPFLAGS -DSGI"
                 if test "X$CC_TRANSFORM" = "X"; then
                    CC_TRANSFORM="cat"
                 fi
...
dnl              done
                 ...
                 SP2)
                    BBH_SUBSYSTEM="SP2"
                    CFLAGS="$CFLAGS -DSPX"
                    CFLAGS_NOOPT="$CFLAGS_NOOPT -DSPX"
                 ...
                 *)
                    ...
                    CFLAGS_NOOPT="$CFLAGS_NOOPT -DRS6000 -D_ALL_SOURCE"
                    CPPFLAGS="$CPPFLAGS -DCPPFLAGS_UNKNOWN"
...
dnl              F77_TRANSFORM="touch";
            ...
            OSF1)
                 ...
                 test "X$CFLAGS" = "X" && CFLAGS="-fast -fptm n -ieee"
                 test "X$CFLAGS_NOOPT" = "X" && CFLAGS_NOOPT="-fptm n -ieee"
                 test "X$F77FLAGS" = "X" && F77FLAGS="-fast -check nopower -fpe4";
                 test "X$F77FLAGSNOOPT" = "X" && F77FLAGSNOOPT="-g -check nopower -fpe4";
                 test "X$LDFLAGS" = "X" && LDFLAGS="-fast"
                                                                  break;;
dnl ----------------------------------------------------------------------
dnl         CRAYS
dnl ----------------------------------------------------------------------
...
dnl ----------------------------------------------------------------------
            LINUX)
dnl ----------------------------------------------------------------------
dnl         Use Fortran compiler to fix BBH_SYSTEM, but now set LF77 var 
dnl         to deal with the case that F77 is a script front-ending to
dnl         the compiler (e.g. mpif77)
dnl ----------------------------------------------------------------------
                 BBH_SET_LF77
                 BBH_SET_LCC
                 case "X$LF77" in
...
dnl                 CPPFLAGS="$CPPFLAGS -DLINUX -D__L -DLINUX_PG -DPORT_GROUP -DWant_c_files"
dnl                 CXXFLAGS="$CXXFLAGS -DLINUX -D__L -DLINUX_PG -DPORT_GROUP -DWant_c_files"
                 ...
                 ;;
                 Xpathf90)
                    BBH_SYSTEM=LINUX_PATH
                    F77_TRANSFORM="touch";
                    if test "X$CC_TRANSFORM" = "X"; then
                       CC_TRANSFORM="cat"
                    fi
                    BBH_DEFS="$BBH_DEFS -DLINUX_PATH"
                    CFLAGS="$CFLAGS"
                    CFLAGS_NOOPT="$CFLAGS_NOOPT"
dnl                 CPPFLAGS="$CPPFLAGS -DLINUX -D__L -DLINUX_PG -DPORT_GROUP -DWant_c_files"
dnl                 CXXFLAGS="$CXXFLAGS -DLINUX -D__L -DLINUX_PG -DPORT_GROUP -DWant_c_files"
                     CPPFLAGS="$CPPFLAGS -DLINUX -DLINUX_PATH -DWant_c_files"
                     CXXFLAGS="$CXXFLAGS -DLINUX -DLINUX_PATH -DWant_c_files"
                    if test "X$CCF77LIBS" = "X"; then
                       CCF77LIBS="-lpathfortran"
                    fi
                 ;;
                 Xefc)
                 ...
                 ;;
                 Xifc|Xifort)
dnl                 AC_MSG_CHECKING(for 32/64 bit type on Intel compilers)
						  if printenv LIBRARY_PATH | grep intel64 > /dev/null; then
                       BBH_SYSTEM=LINUX_INTEL64
dnl				        AC_MSG_RESULT(intel64)
							  AR=xiar
						  else
				           BBH_SYSTEM=LINUX_IA32
dnl				        AC_MSG_RESULT(ia32)
                    fi
dnl			  elif 
                    F77_TRANSFORM="touch";
                    if test "X$CC_TRANSFORM" = "X"; then
                    ...
                    case "X$LCC" in
                    Xicc)
dnl                    AC_MSG_CHECKING(for version of Intel compilers)
                       VERSION=`$F77 -V 2>&1 | grep Version | sed 's/^.*Version[ ]*//g' | sed 's/\..*$//g'`
dnl                    AC_MSG_RESULT($VERSION)
dnl                    AC_MSG_CHECKING(for CCF77LIBS setting)
                       case $VERSION in
                       5|6|7)
                          CPPFLAGS="$CPPFLAGS -DLINUX -DPORT_GROUP -DWant_c_files"
                          CXXFLAGS="$CXXFLAGS -DLINUX -DPORT_GROUP -DWant_c_files"
                       ...
                       8|9|10|11|12|13|14|15|16)
                          CPPFLAGS="$CPPFLAGS -wd177,266 -DINTEL_8_OR_LATER -DLINUX -DPORT_GROUP -DWant_c_files"
                          CXXFLAGS="$CXXFLAGS -DINTEL_8_OR_LATER -DLINUX -DPORT_GROUP -DWant_c_files"
                          if test "X$CCF77LIBS" = "X"; then
                             CCF77LIBS="-lsvml -lifcore -lm"
                          fi
                       ;;
                       *)
                          echo "+++ Warning: Unrecognized version of Intel compilers: $VERSION"
                          echo "+++ Assuming that setting of CPPFLAGS, CXXFLAGS and CCF77LIBS from version 16 will still work"
                          CPPFLAGS="$CPPFLAGS -wd177,266 -DINTEL_8_OR_LATER -DLINUX -DPORT_GROUP -DWant_c_files"
                          CXXFLAGS="$CXXFLAGS -DINTEL_8_OR_LATER -DLINUX -DPORT_GROUP -DWant_c_files"
                          if test "X$CCF77LIBS" = "X"; then
                             CCF77LIBS="-lsvml -lifcore -lm"
...
dnl                    AC_MSG_RESULT($CCF77LIBS)
                    ;;
                    *)
                       echo "+++ Warning: Intel Fortran compiler $F77 being used, but C compiler is $CC"
                    ;;
                    esac
                 ;;
                 *)
                    ...
                    BBH_SETDEF(CFLAGS_NOOPT,"")
                    BBH_SETDEF(CPPFLAGS,"")
                    for comp in gfortran g77; do
                       if $comp --help 2>&1 > /dev/null; then
                         BBH_SETDEF(F77,$comp)
                         BBH_SETDEF(F90,$comp)
                         break
                       fi
                    ...
                    *) ;;
                    ...
                    CXXFLAGS="$CXXFLAGS -DLINUX -DPORT_GROUP -DWant_c_files"
dnl----------------------------------------------------------------------
dnl                 Assume that we are using either gfortran or g77 and 
dnl                 that the version info for g77 will contain reference
dnl                 to itself
dnl----------------------------------------------------------------------
                    if test "X$CCF77LIBS" = "X"; then 
...
dnl ----------------------------------------------------------------------
            DARWIN)
                 ...
                 BBH_SETDEF(CPPFLAGS,"")
                 for comp in gfortran g77; do
                    if $comp --help > /dev/null 2>&1; then
                      BBH_SETDEF(F77,$comp)
                      BBH_SETDEF(F90,$comp)
                       break
                    fi
...
dnl              BBH_SETDEF(F77FLAGS,"-O6 -fno-second-underscore")
dnl              BBH_SETDEF(F77LFLAGS,-O6)
dnl              BBH_SETDEF(F90FLAGS,-O6)
                 BBH_SETDEF(F77FLAGS,"-O2 -fno-second-underscore")
                 BBH_SETDEF(F77LFLAGS,-O2)
                 BBH_SETDEF(F90FLAGS,-O2)
                 F77_TRANSFORM="touch";
                 if test "X$CC_TRANSFORM" = "X"; then
                    CC_TRANSFORM="cat"
                 fi
                 CFLAGS="$CFLAGS"
                 CFLAGS_NOOPT="$CFLAGS_NOOPT"
dnl              CPPFLAGS="$CPPFLAGS -DDARWIN -D__ -DWant_c_files"
                 CPPFLAGS="$CPPFLAGS -I/opt/local/include -DDARWIN -D__L -DWant_c_files"
dnl              CXXFLAGS="$CXXFLAGS -DDARWIN -D__ -DWant_c_files"
                 CXXFLAGS="$CXXFLAGS -DDARWIN -I/opt/local/include -D__L -DWant_c_files"
                 if test "X$CCF77LIBS" = "X"; then
                     case $F77 in
...
dnl              F77_TRANSFORM="touch";
                 ...
                 CFLAGS_NOOPT="$CFLAGS_NOOPT -Aa -D_HPUX_SOURCE -w";
                 CPPFLAGS="$CPPFLAGS -DCPPFLAGS_UNKNOWN"
                                                                  break;;
            *)
                 BBH_SYSTEM=UNKNOWN           ;;
...
dnl Removed test for sv, vs, vsso and added test for xvs.
dnl ----------------------------------------------------------------------
...
AC_DEFUN(BBH_CHECK_RNPL_LIBS_OLD,[
   BBH_CHECK_FATAL="no"
   BBH_RNPLAPP_LIBPATHS="$BBH_RNPLAPP_LIBPATHS $prefix/lib"
   BBH_RNPLAPP_INCPATHS="$BBH_RNPLAPP_INCPATHS $prefix/include"
...
END
         dnl Add $LDFLAGS ... Hack to get around gfortran problem
         dnl following upgrade of Mac OSX 10.10, Darwin 14.0
         if $F77 $LDFLAGS _foo.f -o _foo > /dev/null 2>&1; then
            ac_cv_bbh_prog_f77=$F77
...
dnl Default here designed to handle ADM code and like
         ...
         A/UX)
            F90FLAGSNOOPT=" ";
                                                                    ;;
         OSF1)
            F90FLAGSNOOPT="-fpe4 -check nopower -check nounderflow";
            F90OPT=${F90OPT-"-O4 -fpe4 -check nopower -check nounderflow"};
                                                                    ;;
         UNICOS)
            case $BBH_SUBSYSTEM in
...
AC_DEFUN(BBH_FINDLIB,[
   ...
   if test "X$findlib_done" = "X"; then
      for _stem in ${$1}; do
         if test -f $_stem/lib$2.dylib; then
            $3=$_stem
            break
         fi
      done
...
dnl ----------------------------------------------------------------------
dnl Sets LF77 to name of true Fortran compiler, guessing what's inside 
dnl possible script/front-end to compiler via -V flag
dnl ----------------------------------------------------------------------
AC_DEFUN(BBH_SET_LF77,[
   if test    "X$F77" = X; then
      LF77="None"
   elif $F77 -V 2>&1 | grep -i 'Portland Group' > /dev/null; then
      LF77=pgf77
   elif $F77 -V 2>&1 | grep -i 'Intel Corporation' > /dev/null; then
      LF77=ifort
   elif $F77 --version 2>&1 | grep -i 'PathScale' > /dev/null; then
      LF77=pathf90
   elif $F77 --version 2>&1 | grep -i 'GNU Fortran' > /dev/null; then
      LF77=g77
   else
      LF77="$F77"
   fi
...
dnl ----------------------------------------------------------------------
dnl Sets LCC to name of true C compiler, guessing what's inside 
dnl possible script/front-end to compiler via -V flag
dnl ----------------------------------------------------------------------
AC_DEFUN(BBH_SET_LCC,[
   if test    "X$CC" = X; then
      LCC="None"
   elif $CC -V 2>&1 | grep -i 'Portland Group' > /dev/null; then
      LCC=pgcc
   elif $CC -V 2>&1 | grep -i 'Intel Corporation' > /dev/null; then
      LCC=icc
   elif $CC --version 2>&1 | grep -i 'PathScale' > /dev/null; then
      LCC=pathcc
   elif $CC --version 2>&1 | grep -i 'GNU Fortran' > /dev/null; then
      LCC=gcc
   else
      LCC="$CC"
   fi
...
dnl ----------------------------------------------------------------------
dnl Adds appropriate symbol definition to DEFS depending on version
dnl of gfortran
dnl ----------------------------------------------------------------------
AC_DEFUN(CPPFLAGS_GFORTRAN,[
   if gfortran --version 2>&1 | grep ' 4.1' > /dev/null 2>&1; then
      CPPFLAGS="$CPPFLAGS -DGFORTRAN41";
   elif gfortran --version 2>&1 | grep ' 4.2' > /dev/null 2>&1; then
      CPPFLAGS="$CPPFLAGS -DGFORTRAN42";
   elif gfortran --version 2>&1 | grep ' 4.3' > /dev/null 2>&1; then
      CPPFLAGS="$CPPFLAGS -DGFORTRAN43_OR_LATER";
   elif gfortran --version 2>&1 | grep ' 4.4' > /dev/null 2>&1; then
      CPPFLAGS="$CPPFLAGS -DGFORTRAN43_OR_LATER";
   elif gfortran --version 2>&1 | grep ' 4.5' > /dev/null 2>&1; then
      CPPFLAGS="$CPPFLAGS -DGFORTRAN43_OR_LATER";
   elif gfortran --version 2>&1 | grep ' 4.6' > /dev/null 2>&1; then
      CPPFLAGS="$CPPFLAGS -DGFORTRAN43_OR_LATER";
   elif gfortran --version 2>&1 | grep ' 4.7' > /dev/null 2>&1; then
      CPPFLAGS="$CPPFLAGS -DGFORTRAN43_OR_LATER";
   elif gfortran --version 2>&1 | grep ' 4.8' > /dev/null 2>&1; then
      CPPFLAGS="$CPPFLAGS -DGFORTRAN43_OR_LATER";
   elif gfortran --version 2>&1 | grep ' 4.9' > /dev/null 2>&1; then
      CPPFLAGS="$CPPFLAGS -DGFORTRAN43_OR_LATER";
   elif gfortran --version 2>&1 | grep ' 5.0' > /dev/null 2>&1; then
      CPPFLAGS="$CPPFLAGS -DGFORTRAN43_OR_LATER";
   elif gfortran --version 2>&1 | grep ' 5.1' > /dev/null 2>&1; then
      CPPFLAGS="$CPPFLAGS -DGFORTRAN43_OR_LATER";
   elif gfortran --version 2>&1 | grep ' 5.2' > /dev/null 2>&1; then
      CPPFLAGS="$CPPFLAGS -DGFORTRAN43_OR_LATER";
   elif gfortran --version 2>&1 | grep ' 5.3' > /dev/null 2>&1; then
      CPPFLAGS="$CPPFLAGS -DGFORTRAN43_OR_LATER";
   elif gfortran --version 2>&1 | grep ' 5.4' > /dev/null 2>&1; then
      CPPFLAGS="$CPPFLAGS -DGFORTRAN43_OR_LATER";
   else
      AC_MSG_RESULT(Warning! Unimplemented version of gfortran encountered)
   fi
])
